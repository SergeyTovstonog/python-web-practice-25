"""
Iterable є однією з центральних концепцій в Python. У контексті типізації,
Iterable - це тип, що вказує на те, що об'єкт може бути проходжений (ітерованим).
Якщо клас реалізує метод __iter__(), він є ітерованим.
