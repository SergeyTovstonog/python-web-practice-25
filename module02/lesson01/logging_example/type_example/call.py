"""
В модулі typing, Callable використовується для опису змінних або
об'єктів, які "викликаються", тобто можуть бути використані як функції.
Це корисно, коли ви хочете передати функцію як аргумент іншій функції,
або коли ви хочете повернути функцію з функції.
"""
